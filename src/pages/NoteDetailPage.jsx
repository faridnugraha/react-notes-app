...
function NoteDetailPage({ deleteHandler, archivedHandler}){
    const { id } = useParams()
    ...
    function onArchivedHandler(){
        archivedHandler(note.id, note.archived)
        setNote(getNote(id))
    }
                ...
                <Col xs md={6}>
                    ...
                    <Card>
                        ...
                        <Card.Footer className="d-flex justify-content-end">
                            <NoteManageButton id={note.id} archived={note.archived} onArchiveToggle={onArchivedHandler} deleteButtonHandler={onDeleteHandler}/>
                        </Card.Footer>
                    </Card>
                </Col>
            </Row>
